...
import {StyleSheet, View, Text, TouchableOpacity, Slider, ActivityIndicator, Modal, Platform} from 'react-native';
...
export default class PlayMovie extends Component {
  ...
  render() {
    ...
    return (
        <TouchableOpacity
          style={[styles.movieContainer, {height: orientation === 'PORTRAIT' ? 250 : DeviceInfo.deviceWidth,
