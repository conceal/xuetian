            ...
            <View style={{justifyContent: 'space-around'}}>
              {
                data.isTicket ?
                    ...
                    <TouchableOpacity style={styles.loveHeart} onPress={()=> this.setState({isLove: !this.state.isLove})}>
                      {
                        this.state.isLove ?
                            <Icon name="heart" size={15} color={ '#F9783F'} /> :
                            <Icon name="heart-o" size={12} color={ '#F9783F'} />
                      }
