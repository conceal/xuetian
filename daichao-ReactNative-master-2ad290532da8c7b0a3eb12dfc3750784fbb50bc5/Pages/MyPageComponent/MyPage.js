        ...
        if (this.state.login === true){
            return<View style={{justifyContent: 'center'}}>
                <View style={{
                    ...
                    <Text style={styles.nameStyle}>狄仁杰</Text>
                    <Text style={{
            ...
            return<View style={{justifyContent:'center',paddingTop:ScreenUtils.scaleSize(35),paddingRight:ScreenUtils.scaleSize(80)}}>
                <Text style={{fontSize: ScreenUtils.setSpText(16)}}>极简借贷 轻松解决燃眉之急</Text>
                <TouchableOpacity
        ...
        return <View style={styles.container}>
            ...
            <View style={styles.row2Style}>
                ...
                <View style={styles.centerStyle}>
                    <View style={{justifyContent: 'center', paddingLeft: ScreenUtils.scaleSize(30)}}>
            ...
            <View>
                ...
                <TouchableOpacity style={styles.rowStyle}>
                    ...
                    <View style={styles.rightStyle}>
                        ...
                        <View style={{height: ScreenUtils.scaleSize(80),
                            ...
                            alignItems:'center'}}
                        >
                            <Text style={styles.icon02t}>213624</Text>
                        </View>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={styles.rowStyle}>
                    ...
                    <View style={styles.rightStyle}>
                        ...
                        <View style={{height: ScreenUtils.scaleSize(80),
                                ...
                                alignItems:'center'}}
                        >
                            <Text style={styles.icon02t}>0.02元</Text>
                        </View>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity
